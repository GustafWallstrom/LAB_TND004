...
int main( )
{
	...
	/**************************************/
	cout << "PHASE 4: BiIterator validity" << endl;
	/**************************************/

	BinarySearchTree<string>::BiIterator it = T.contains("aerobic");
	T.remove("aerobic");

	cout << endl;

	cout << "Iterator on key 'aerobic', removing 'aerobic'" << endl;

	cout << "Dereferencing iterator leads to: " << *it;
