...
int main()
{
	...
	*ptr_S += 24;
	...
	//cout << "std::move(*ptr_S) * S5 = " << std::move(*ptr_S) * S5 << endl;		//{3 4 24} - Calls move constructor
	cout << "S5 * std::move(*ptr_S)  = " << S5 * std::move(*ptr_S) << endl;		//{3 4 24} - Calls copy constructor
